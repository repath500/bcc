...
// .wrangler/tmp/bundle-9uaXX1/checked-fetch.js
...
var require_dist_node3 = __commonJS({
  "../../node_modules/.pnpm/@octokit+graphql@7.1.1/node_modules/@octokit/graphql/dist-node/index.js"(exports, module) {
    ...
    __export2(index_exports, {
      GraphqlResponseError: /* @__PURE__ */ __name(() => GraphqlResponseError, "GraphqlResponseError"),
      graphql: /* @__PURE__ */ __name(() => graphql2, "graphql"),
      withCustomRequest: /* @__PURE__ */ __name(() => withCustomRequest, "withCustomRequest")
    });
...
var require_dist_node5 = __commonJS({
  "../../node_modules/.pnpm/@octokit+oauth-methods@4.1.0/node_modules/@octokit/oauth-methods/dist-node/index.js"(exports, module) {
    ...
    __export2(dist_src_exports, {
      VERSION: /* @__PURE__ */ __name(() => VERSION8, "VERSION"),
      checkToken: /* @__PURE__ */ __name(() => checkToken2, "checkToken"),
      createDeviceCode: /* @__PURE__ */ __name(() => createDeviceCode2, "createDeviceCode"),
      deleteAuthorization: /* @__PURE__ */ __name(() => deleteAuthorization2, "deleteAuthorization"),
      deleteToken: /* @__PURE__ */ __name(() => deleteToken2, "deleteToken"),
      exchangeDeviceCode: /* @__PURE__ */ __name(() => exchangeDeviceCode2, "exchangeDeviceCode"),
      exchangeWebFlowCode: /* @__PURE__ */ __name(() => exchangeWebFlowCode2, "exchangeWebFlowCode"),
      getWebFlowAuthorizationUrl: /* @__PURE__ */ __name(() => getWebFlowAuthorizationUrl, "getWebFlowAuthorizationUrl"),
      refreshToken: /* @__PURE__ */ __name(() => refreshToken2, "refreshToken"),
      resetToken: /* @__PURE__ */ __name(() => resetToken2, "resetToken"),
      scopeToken: /* @__PURE__ */ __name(() => scopeToken, "scopeToken")
    });
...
function r(t2) {
  for (var n2 = new ArrayBuffer(t2.length), r2 = new Uint8Array(n2), e2 = 0, i2 = t2.length; e2 < i2; e2++) r2[e2] = t2.charCodeAt(e2);
  return n2;
}
function e(t2) {
  ...
  "../../node_modules/.pnpm/universal-github-app-jwt@1.2.0/node_modules/universal-github-app-jwt/dist-web/index.bundled.js"() {
    ...
    a = (function() {
      var t2 = n((function* (t3) {
        ...
        if (/BEGIN RSA PRIVATE KEY/.test(n2)) throw new Error("[universal-github-app-jwt] Private Key is in PKCS#1 format, but only PKCS#8 is supported. See https://github.com/gr2m/universal-github-app-jwt#readme");
        var o2, u2 = { name: "RSASSA-PKCS1-v1_5", hash: { name: "SHA-256" } }, c = (o2 = n2.trim().split("\n").slice(1, -1).join(""), r(atob(o2))), p = yield crypto.subtle.importKey("pkcs8", c, u2, false, ["sign"]), f = (function(t4, n3) {
          ...
          for (var n3 = "", r2 = new Uint8Array(t4), i2 = r2.byteLength, a3 = 0; a3 < i2; a3++) n3 += String.fromCharCode(r2[a3]);
          return e(btoa(n3));
...
var require_dist_node6 = __commonJS({
  "../../node_modules/.pnpm/@octokit+auth-app@6.1.4/node_modules/@octokit/auth-app/dist-node/index.js"(exports, module) {
    ...
    var dist_src_exports = {};
    __export2(dist_src_exports, {
      createAppAuth: /* @__PURE__ */ __name(() => createAppAuth4, "createAppAuth"),
      createOAuthUserAuth: /* @__PURE__ */ __name(() => import_auth_oauth_user22.createOAuthUserAuth, "createOAuthUserAuth")
    });
    module.exports = __toCommonJS2(dist_src_exports);
    var import_universal_user_agent6 = require_dist_node();
    var import_request6 = (init_dist_web3(), __toCommonJS(dist_web_exports2));
...
var require_dist_node7 = __commonJS({
  "../../node_modules/.pnpm/@octokit+auth-unauthenticated@5.0.1/node_modules/@octokit/auth-unauthenticated/dist-node/index.js"(exports, module) {
    ...
    var dist_src_exports = {};
    __export2(dist_src_exports, {
      createUnauthenticatedAuth: /* @__PURE__ */ __name(() => createUnauthenticatedAuth2, "createUnauthenticatedAuth")
    });
    module.exports = __toCommonJS2(dist_src_exports);
...
var require_dist_node8 = __commonJS({
  "../../node_modules/.pnpm/@octokit+oauth-app@6.1.0/node_modules/@octokit/oauth-app/dist-node/index.js"(exports, module) {
    ...
    var dist_src_exports = {};
    __export2(dist_src_exports, {
      OAuthApp: /* @__PURE__ */ __name(() => OAuthApp2, "OAuthApp"),
      createAWSLambdaAPIGatewayV2Handler: /* @__PURE__ */ __name(() => createAWSLambdaAPIGatewayV2Handler, "createAWSLambdaAPIGatewayV2Handler"),
      createNodeMiddleware: /* @__PURE__ */ __name(() => createNodeMiddleware, "createNodeMiddleware"),
      createWebWorkerHandler: /* @__PURE__ */ __name(() => createWebWorkerHandler, "createWebWorkerHandler"),
      handleRequest: /* @__PURE__ */ __name(() => handleRequest, "handleRequest"),
      sendNodeResponse: /* @__PURE__ */ __name(() => sendResponse, "sendNodeResponse"),
      unknownRouteResponse: /* @__PURE__ */ __name(() => unknownRouteResponse, "unknownRouteResponse")
    });
    module.exports = __toCommonJS2(dist_src_exports);
    var import_auth_oauth_app = (init_dist_web8(), __toCommonJS(dist_web_exports6));
    var VERSION8 = "6.1.0";
...
<p>Your token is: <strong>${token2}</strong>. Copy it now as it cannot be shown again.</p>`
    ...
    function parseRequest2(request2) {
      ...
      return {
        ...
        url: request2.url,
        headers,
        text: /* @__PURE__ */ __name(() => request2.text(), "text")
      };
    }
...
// .wrangler/tmp/bundle-9uaXX1/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-9uaXX1/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
